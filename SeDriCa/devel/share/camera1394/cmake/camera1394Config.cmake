...
if("TRUE" STREQUAL "TRUE")
  set(camera1394_SOURCE_PREFIX /home/admin/SeDriCa/src/sensors/src/stereo/camera1394)
  set(camera1394_DEVEL_PREFIX /home/admin/SeDriCa/devel)
  ...
  set(camera1394_INSTALL_PREFIX /home/admin/SeDriCa/install)
...
if(NOT "/home/admin/SeDriCa/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera1394' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/admin/SeDriCa/src/sensors/src/stereo/camera1394/${idir}'.  ${_report}")
    endif()
