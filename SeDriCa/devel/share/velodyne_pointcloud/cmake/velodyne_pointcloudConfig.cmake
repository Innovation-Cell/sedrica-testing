...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/admin/SeDriCa/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/admin/SeDriCa/install)
...
if(NOT "/home/admin/SeDriCa/devel/include;/home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/admin/SeDriCa/devel/include;/home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_pointcloud/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
