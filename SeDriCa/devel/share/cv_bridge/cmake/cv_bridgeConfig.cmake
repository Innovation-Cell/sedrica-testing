...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/admin/SeDriCa/src/sensors/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/admin/SeDriCa/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/admin/SeDriCa/install)
...
if(NOT "/home/admin/SeDriCa/src/sensors/src/cv_bridge/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/admin/SeDriCa/src/sensors/src/cv_bridge/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/admin/SeDriCa/src/sensors/src/cv_bridge/${idir}'.  ${_report}")
    endif()
