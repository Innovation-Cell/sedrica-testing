...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/admin/SeDriCa/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/admin/SeDriCa/install)
...
if(NOT "/home/admin/SeDriCa/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/admin/SeDriCa/src/sensors/src/3d_lidar/velodyne/velodyne_laserscan/${idir}'.  ${_report}")
    endif()
