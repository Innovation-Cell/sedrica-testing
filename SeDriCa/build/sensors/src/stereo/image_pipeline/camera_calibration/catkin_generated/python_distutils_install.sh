...
echo_and_run cd "/home/admin/SeDriCa/src/sensors/src/stereo/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/home/admin/SeDriCa/src/sensors/src/stereo/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/admin/SeDriCa/build/sensors/src/stereo/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
